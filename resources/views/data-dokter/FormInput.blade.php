...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Input Data Dokter </h2>
        </div>
    </div>
</div>
<!-- ============================================================== -->
...
<!-- ============================================================== -->
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/data-dokter/store" method="post">
                    {{ csrf_field() }}
                    <div class="form-row">
                        <div class="form-group col-4">
                            <label for="nid">Nomor Induk Dokter</label>
                            <input type="text" name="nid" class="form-control" placeholder="Masukkan Nid" required value="{{ old('nid') }}">
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-8">
                            ...
                            <input type="text" name="spesialis" class="form-control" placeholder="Spesialis Dokter" required value="{{ old('spesialis') }}">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12">
                            <label for="no_telp">Nomor Telepon</label>
                            <input type="text" name="no_telp" class="form-control" placeholder="Masukkan Nomor Telepon/Hp Dokter" required value="{{ old('no_telp') }}">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12">

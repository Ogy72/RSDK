                ...
                <form action="/data-obat/store" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col-4">
                            ...
                            <input type="text" name="kode_obat" class="form-control" placeholder="Masukkan Kode Obat" required value="{{ old('kode_obat') }}">
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-2">
                            ...
                            <select id="satuan" name="satuan"  class="form-control form-control-sm" required>
